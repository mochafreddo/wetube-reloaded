...
export const home = async (req, res) => {
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to fetch videos.' });
  }
};
...
export const watch = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to fetch video.' });
  }
};
...
export const getEdit = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to fetch video for editing.' });
  }
};
...
export const postEdit = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to update video.' });
  }
};
...
export const deleteVideo = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to delete video.' });
  }
};
...
export const search = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).render('error', { pageTitle: 'Error', errorMessage: 'Failed to search for videos.' });
  }
};
